...
class DataBase {
    ...
    private _cadenaConexio2: string = `mongodb+srv://Admin:Admin@cluster0.0gnym.mongodb.net/Premier?retryWrites=true&w=majority` 
    private _cadenaConexion:string= `mongodb+srv://Admin:Admin@cluster0.0gnym.mongodb.net/PruebaProyecto2?retryWrites=true&w=majority`
    constructor(){
